...
#define defaults_h
  ...
  #define DEFAULT_STATUS_REPORT_MASK ((BITFLAG_RT_STATUS_MACHINE_POSITION)|(BITFLAG_RT_STATUS_WORK_POSITION)|(BITFLAG_RT_STATUS_PUMP_PWM)|(BITFLAG_RT_STATUS_Coordinate_MODE))
