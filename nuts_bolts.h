...
#define N_AXIS 7 // Number of axes
...
#define N_Cartesian 6 // Number of axes 增加的用来表示笛卡尔坐标值和姿态绕XYZ固定轴旋转的轴宏定义编号
#define X_Cartesian 0 // Axis indexing value. 
#define Y_Cartesian 1
#define Z_Cartesian 2
#define RX_Cartesian 3
#define RY_Cartesian 4
#define RZ_Cartesian 5
